...
const LoginPage = () => {
  ...
  const delayToastTimer = useRef(null);

  const clearToastTimer = () => {
    if (delayToastTimer.current) {
      clearTimeout(delayToastTimer.current);
    }
  };
  ...
  const onSubmitHandler = async (e) => {
    ...
    // Start 3s timer to show toast
    delayToastTimer.current = setTimeout(() => {
